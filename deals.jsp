...
<div id="shoplist" class="row">
       ...
       PreparedStatement ps=cn.prepareStatement("SELECT * FROM products where status='Active' and cat='Deal' ;");
...
<div class="shop-item-title clearfix" style="height: 200px;">
    <div style="height: 100px;" ><h5><a href="shop-single.jsp?pid=<%=rs1.getString("pid")%>&&subcat=<%=rs1.getString("subcat")%>&&discount=<%=rs1.getString("discount")%>"><%=rs1.getString("pname")%></a></h5></div>
...
<a data-tooltip="tooltip" data-placement="top" title="Quick View" href="shop-single.jsp?pid=<%=rs1.getString("pid")%>&&subcat=<%=rs1.getString("subcat")%>&&discount=<%=rs1.getString("discount")%>"><span class="fa fa-eye"></span></a>
</div>
</div>
</div>
<%}%>
