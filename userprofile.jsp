...
<hr>
<div id="single-shop" class="row" style="height: 600px;">
<div class="col-lg-12">
<div class="row">
    <div class="col-md-12">
        <div class="col-md-4">
        <div class="menu_section">
              ...
              <ul class="nav side-menu">
                   ...
                   <li><a href="userprofile.jsp"><i class="fa fa-bar-chart-o"></i>Profile Page<span class="fa fa-w"></span></a>
                </li>
                <li><a href="userbooking.jsp?emailu=<%=emailu%>"><i class="fa fa-envelope"></i>My Order<span class="fa fa-envelope-o"></span></a>
                </li>
 <li><a href="postfeedback.jsp?emailu=<%=emailu%>"><i class="fa fa-envelope"></i>Add Testimonial<span class="fa fa-envelope-o"></span></a>
                </li>
       ...
       <%
            ...
            PreparedStatement ps6=cn.prepareStatement("SELECT * FROM userregister where email='"+emailu+"';");
...
<div class="col-md-4 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.4s">
    <img class="img-responsive" src="img/gql.png"   alt="">
    <div class="">
        <input type="text" class="form-control"  style="color: #000;" readonly="" value="<%=rs6.getString("name")%>" ></div>
</div>
        
<form action="updateprofile?id=<%=id%>&&name=<%=rs6.getString("name")%>&&emailu=<%=emailu%>" method="post" enctype="multipart/form-data">
...
<%}else{%>
<div class="col-md-4 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.4s">
    <img class="img-responsive" src="adminpannel/Admin/images/<%=rs6.getString("image")%>"alt="">
    <div class="">
        <input type="text" class="form-control" style="color: #000;" readonly="" value="<%=rs6.getString("name")%>" ></div>
</div>
