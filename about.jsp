...
<div class="col-lg-12">
    <h1><strong style="align-self: center;">Why Choose us</strong></h1>
<div class="row">
      <%
       Class.forName("com.mysql.jdbc.Driver");
       Connection cn=new connect_db().getConnection();
       PreparedStatement ps1=cn.prepareStatement("SELECT * FROM termsheading  ;");
       ResultSet rs1=ps1.executeQuery();
      while(rs1.next()){
        
        %>
<div class="col-md-8 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.4s">
    <img class="img-responsive" src="adminpannel/Admin/images/<%=rs1.getString("termsheading")%>" alt="">
</div>
    <%}%>
<div class="">
...
<div class="row service">
       ...
       PreparedStatement ps=cn.prepareStatement("SELECT * FROM aboutus where status='Active' limit 5 ;");
       ResultSet rs=ps.executeQuery();
      while(rs.next()){
        
        %>
<div class="col-md-4 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
<h3><i class="fa fa-check-circle-o"></i><%=rs.getString("heading")%></h3>
