...
<ul class="nav navbar-nav ">
    <li ><a href="#" data-toggle="dropdown" class="dropdown-toggle"><b>Occasion</b></a>
<ul >
<%   PreparedStatement ps51=cn.prepareStatement("SELECT * FROM subcategory where cname='Occassion' and  status='Active' ;");
           ResultSet rs51=ps51.executeQuery();
          while(rs51.next()){
 %>
 <div class="col-md-12" style="height: 30px;">
 <li class="fa fa-check-circle-o"><a href="hotsellern.jsp?subcat=<%=rs51.getString("sname")%>&low=<%=low%>&max=<%=max%>"><%=rs51.getString("sname")%></a></li>
 </div>
     <%}%>
</ul>
</li>
...
<div class="" style="border: solid;">
    ...
    <form action="hotsellern.jsp" method="post">
        <fieldset >
       ...
       PreparedStatement ps=cn.prepareStatement("SELECT * FROM orders where price BETWEEN "+low+" and "+max+" and subcat='"+subcat+"'  group by pname order by count(oid) desc limit 20   ;");
