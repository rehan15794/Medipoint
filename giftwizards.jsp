...
<li class="active">Gift Wizards</li>
</ol>
</div>
</div>
<hr>
...
<div class="" style="border: solid;">
    ...
    <form action="giftwizard.jsp?subcat=<%=subcat%>" method="post">
        <fieldset >
       ...
       PreparedStatement ps=cn.prepareStatement("SELECT * FROM products where price BETWEEN "+low+" and "+max+" and cat='Giftwizard'  limit 20  ;");
