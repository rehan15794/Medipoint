...
<li><a href="index-two.jsp">My Account</a></li>
...
<div class="input-group">
    <input type="text" class="form-control" name="trackid" placeholder="Track your order.."/>
...
<%
       ...
       PreparedStatement ps=cn.prepareStatement("SELECT * FROM orders where email='"+emailu+"' and trackid='"+trackid+"' ;");
...
<div class="" style="border: solid;">
    <div style="height: 60px; background-color: lightgreen;">
        ...
        <div class="col-md-12">
            <div class="col-md-8">
                <input type="submit" class="btn btn-success" style="margin-top: 10px; background-color: " value="Order Id <%=rs1.getString("trackid")%>">
            </div>
            <div class="col-md-4">
                <a href="trackorder.jsp?oid=<%=rs1.getString("oid")%>" ><button class="btn btn-primary" style="margin-top: 10px;" ><i class="fa fa-map-marker"></i><s></s>   Track Your Order </button></a>
            </div>
        </div>
    ...
    <div style="height: 200px;">
        ...
        <div class="col-md-12">
        <div class="col-md-2">
            <img src="adminpannel/Admin/images/<%=rs1.getString("imagea")%>" height="100px" width="100px" >
        </div>
        <div class="col-md-3">
            <h><%=rs1.getString("pname")%></h>
        </div>
                <div class="col-md-2">
            <h><%=rs1.getString("price")%></h>
        </div>
                <div class="col-md-2">
            <h><%=rs1.getString("bookingstatus")%></h>
        </div>
        ...
        <div class="col-md-12" style="margin-top: 15px;">
            ...
            <button class="btn btn-primary"><h>Order On  </h> <%=rs1.getString("dateofbooking")%></button>
        </div>
