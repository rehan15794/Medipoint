    ...
    <div class="col-md-12">
        ...
        <div class="menu_section">
              ...
              <ul class="nav side-menu">
                   ...
                   <li><a href="agentprofile.jsp"><i class="fa fa-bar-chart-o"></i>Profile Page<span class="fa fa-w"></span></a>
                </li>
       ...
       <%
            ...
            PreparedStatement ps6=cn.prepareStatement("SELECT * FROM agentregister where email='"+emailag+"';");
...
<div class="col-md-4 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.4s">
    <img class="img-responsive" src="images/<%=rs6.getString("image")%>"alt="">
    <div>
