...
<title>Friendship Day Gifts</title>
...
<div class="row">
<div class="col-md-8">
<h2> Friendship Day Gifts</h2>
</div>
    
<div class="col-md-4">
<ol class="breadcrumb text-right">
<li><a href="#">Home</a></li>
<li class="active">Friendship Day Gifts</li>
</ol>
</div>
...
<div id="shoplist" class="portfolio">
    <%
        ...
        PreparedStatement stmt = con.prepareStatement("select * from product where occasions='FriendshipDay'");
