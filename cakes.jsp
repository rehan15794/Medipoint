...
<li class="active">Same Day Delivery</li>
</ol>
</div>
</div>
<hr>
...
<ul class="nav navbar-nav ">
    <li ><a href="#" data-toggle="dropdown" class="dropdown-toggle"><b>Same Day Delivery</b></a>
<ul >
<%   PreparedStatement ps51=cn.prepareStatement("SELECT * FROM subcategory where cname='Same Day Delivery' and  status='Active' ;");
           ResultSet rs51=ps51.executeQuery();
          while(rs51.next()){
 %>
 <div class="col-md-12" style="height: 30px;">
 <li class="fa fa-check-circle-o"><a href="cakes.jsp?subcat=<%=rs51.getString("sname")%>&low=<%=low%>&max=<%=max%>"><%=rs51.getString("sname")%></a></li>
 </div>
     <%}%>
</ul>
</li>
...
<div class="" style="border: solid;">
    ...
    <form action="cakes.jsp?subcat=<%=subcat%>" method="post">
        <fieldset >
