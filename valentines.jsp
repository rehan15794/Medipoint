       ...
       Connection cn=new connect_db().getConnection();
        ...
        %>
            ...
            int max=10000;
               ...
               String subcat=request.getParameter("sname");
...
<%   PreparedStatement ps51=cn.prepareStatement("SELECT * FROM subcategory where cname='Occassion' and  status='Active' ;");
 ...
 <li class="fa fa-check-circle-o"><a href="valentine.jsp?subcat=<%=rs51.getString("sname")%>&low=<%=low%>&max=<%=max%>"><%=rs51.getString("sname")%></a></li>
 </div>
     <%}%>
</ul>
</li>
...
<div class="" style="border: solid;">
    ...
    <form action="valentine.jsp?subcat=<%=subcat%>" method="post">
        <fieldset >
       ...
       PreparedStatement ps=cn.prepareStatement("SELECT * FROM products where price BETWEEN "+low+" and "+max+" and subcat='"+subcat+"' limit 20  ;");
