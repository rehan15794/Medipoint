...
<div class="page-wrapper white-section clearfix" style="height: 500px;">
<div class="row">
<div class="col-md-8">
<h2>Business Asociater</h2>
</div>
<div class="col-md-4">
...
<div class="contact_list clearfix">
 <script src="js/jquery-1.11.3.min.js" type="text/javascript"></script>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:100px;overflow:hidden;visibility:hidden;">
       ...
       PreparedStatement ps2=cn2.prepareStatement("SELECT * FROM associater ;");
       ResultSet rs2=ps2.executeQuery();
  while(rs2.next()){
        
        %>
            <div>
                <img data-u="image" src="img/<%=rs2.getString("image")%>" />
            </div>
   <%}%>
        </div>
    </div>
