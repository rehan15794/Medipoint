...
<div class="relative">
    ...
    <img src="adminpannel/Admin/images/<%=imagea%>" height="150" width="150" alt="">

</div>
</div>
</th>
<th>
    <a href="shop-single.jsp?pid=<%=pid%>"><%=pname%></a>
</th>
<td><%=price%></td>
<td>
...
<form method="post" action="productdqtys?oid=<%=rset.getString("oid")%>&&email=<%=emailu%>" >

     
    <input type="hidden"  value="<%=qty%>" name="quantity"> &nbsp;&nbsp;
        <button  class="fa fa-minus btn btn-submit" ></button>
...
<form method="post" action="productqty?oid=<%=rset.getString("oid")%>&&email=<%=emailu%>" >
    ...
    <input type="text"  value="<%=qty%>" readonly="" class="col-md-3" name="quantity"> <br><br>&nbsp;&nbsp;
        <button  class="fa fa-plus btn btn-submit" ></button>
...
<div class="form-group">
    <input type="text" class="" placeholder="Coupon code" name="cname">
</div>
<div class="form-group">
