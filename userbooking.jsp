...
<hr>    <%
       ...
       PreparedStatement ps=cn.prepareStatement("SELECT * FROM orders where email='"+emailu+"' ;");
...
<div class="" style="border: solid;">
    <div style="height: 60px; background-color: lightgreen;">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <a href="trackorder.jsp?trackid=<%=rs1.getString("trackid")%>" ><button class="btn btn-primary" style="margin-top: 10px;" ><i class="fa fa-map-marker"></i><s></s>   Track Your Order </button></a>
            </div>
        </div>
