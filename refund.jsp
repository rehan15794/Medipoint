...
<div class="panel-group" id="accordion">
       ...
       PreparedStatement ps=cn.prepareStatement("SELECT * FROM refund  ;");
...
<a class="accordion-toggle" data-toggle="" data-parent="#accordion" href="">
<h3><%=rs.getString("ques")%></h3>
</a><i class="indicator"></i>
</div>
</div>
<div id="collapseOne" class="panel-collapse collapse in">
<div class="panel-body">
    <blockquote class="normalquote"><%=rs.getString("ans")%></blockquote>
</div>
</div>
</div>
<%}%>
