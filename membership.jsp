...
<div class="container">
 <section class="about-box ser-section">
     <h1 class="" style="color: tomato;">Membership Plan</h1>
     <br><br><br>
    <div class="container">
      <div class="row">
      ...
      Class.forName("com.mysql.jdbc.Driver");
       ...
       PreparedStatement ps2=cn.prepareStatement("SELECT * FROM membership  ;");
       ResultSet rs2=ps2.executeQuery();
        ...
        %>
              ...
              <div class="container">
  <img src="images/Samsher Ali Khan.jpg" alt="Nature" style="width:25%;">
 <!-- <div class="text-block">
    ...
    <div>  <input type="text" name="plan" value="<%=rs2.getString("plan")%>"  readonly/> </div>
     <div> <input type="text" name="price" value="<%=rs2.getString("price")%>"  readonly/> </div>
