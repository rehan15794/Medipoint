...
<div id="shoplist" class="row">
       ...
       PreparedStatement ps=cn.prepareStatement("SELECT * FROM products WHERE pname LIKE '%"+pname+"%' limit 20 ;");
...
<div class="shop-item-title clearfix" style="height: 200px;">
    <div style="height: 100px;" ><h4><a href="shop-single.jsp?pid=<%=rs1.getString("pid")%>&&subcat=<%=rs1.getString("subcat")%>&&discount=<%=rs1.getString("discount")%>"><%=rs1.getString("pname")%></a></h4></div>
