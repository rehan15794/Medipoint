...
<div id="single-shop" class="row">
					<div class="col-md-12">
                                            <form method="post" action="placeorder?email=<%=emailu%>">
									...
									<div class="row">
										<div class=" col-md-6">
											<label>Full Name *</label>
                                                                                        <input type="text" name="name" required=""  pattern="[A-Za-z\s]{3,}" title="atlest 3 digits and only alphabet" class="form-control" placeholder="Full Name">
										</div>
                                                                            <div class="col-md-6">
											
											<label>Phone Number *</label>
											<input type="text" name="mobile"  pattern="[6-9][0-9]{9}" title="ten digit mobile no which start from 6-9 digits"  required=""  class="form-control" placeholder="Phone Number">
										</div>
										<div class="col-md-12">
											<label>Address Line</label>
                                                                                        <textarea type="text" name="address" rows="5" required=""  class="form-control" placeholder="Address Line "></textarea>
										</div>
                                                                            
										<div class="col-md-6">
											<label>Town / City *</label>
                                                                                        <input type="text" name="city" required="" class="form-control" placeholder="Town / City">
										</div>
										...
										<div class="col-md-6">
                                            ...
                                            <label class="checkbox payment-method inline">
                                                <input type="checkbox" id="customCheck3" required="" > CASH ON DELIVERY
								</label>
