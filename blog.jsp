...
<div id="content" class="col-md-12 col-sm-12">
     <%
       ...
       PreparedStatement ps=cn.prepareStatement("SELECT * FROM blog order by id desc limit 4 ;");
...
<a href="#" title=""><img src="adminpannel/Admin/images/<%=rs.getString("image")%>" height="500" width="100%" alt="" class=""></a>
</div>
<div class="post-content">
    <h2><a href="#" class="fa fa-check-circle-o" ><%=rs.getString("name")%></a></h2>
    <blockquote class="normalquote"><%=rs.getString("message")%></blockquote>
